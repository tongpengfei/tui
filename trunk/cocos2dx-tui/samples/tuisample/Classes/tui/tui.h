...
/**
 @class Tui
 @brief Tui extends from CCLayer, a tui panel is a Tui, a Tui includes
 		some images, buttons and so on, Tui is created by parse tui 
		xml file. tui xml is generated by flash cs extension TGameUITool.
 */
class TuiManager;
